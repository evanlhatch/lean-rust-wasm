...
pub type HostResult<T> = Result<T, fast_observe::exn::Fault<HostFault>>;
...
impl ComponentRuntime {
    ...
    pub async fn new(engine: HostEngine, caps: CapabilitySet) -> HostResult<Self> {
    ...
    pub async fn call(&mut self, func: &str, args: &[Val]) -> HostResult<Vec<Val>> {
        ...
        // is the guestlang-host's execution model).
    ...
    pub fn fuel_left(&self) -> HostResult<u64> {
    ...
    pub fn instantiate_pre(
        &mut self,
        component: &wasmtime::component::Component,
    ) -> HostResult<wasmtime::component::InstancePre<HostState>> {
...
fn default_val(ty: Type) -> HostResult<Val> {
    Ok(match ty {

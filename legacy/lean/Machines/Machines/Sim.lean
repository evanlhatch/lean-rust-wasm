...
-- the @[simp] equation set for runSim/simTrace — GENERATED by
-- `declare_eqns` (plan §4, family 3).

declare_eqns runSim with runSim_nil runSim_cons

declare_eqns simTrace with simTrace_nil simTrace_cons

...
// spec 442210c+ | SchemaLang.OracleMirror (compareTableRows/classifyRows + the ser-form constants; pinned against Oracle.lean) | 16 item(s) | content hash 5925729753731452982 | regen: just gen; drift fails CI
...
pub fn ser_val(v: &Val) -> String {
    match v {
        ...
        Val::Result(Ok(Some(inner))) => format!("ok({})", ser_val(inner)),
        Val::Result(Err(None)) => "err".into(),
        Val::Result(Err(Some(inner))) => format!("err({})", ser_val(inner)),

/- Axiom gate — the headline theorems must print only the core triple
   ...
   `Substrait.Substrait`). The lineage's `splitTopLevel_join_rbracket` /
...
#print axioms Substrait.Decode.Text.parseType_mono
#print axioms Substrait.Decode.Text.parseType_mono_of_le
...
#print axioms Substrait.Substrait.TCtor.prefix_unique
#print axioms Substrait.Decode.Text.lexCtor_self
#print axioms Substrait.Decode.Text.parseType_scalar
#print axioms Substrait.Decode.Text.parseType_scalar_nullable
#print axioms Substrait.Decode.Text.scalarT
#print axioms Substrait.Decode.Text.parseType_typeText

-- the expression inversions (field refs, bool/int literals, escape round-trip)
#print axioms Substrait.Decode.Text.parseExpr_field
#print axioms Substrait.Decode.Text.parseExpr_lit_bool
#print axioms Substrait.Decode.Text.parseExpr_lit_i64
#print axioms Substrait.Decode.Text.unescape_escape

-- the relation layer (parseNamedCol + the splitAppend inversion chain)
#print axioms Substrait.Decode.Text.parseNamedCol_emitted
#print axioms Substrait.Decode.Text.splitAppend_map_parseNamedCol

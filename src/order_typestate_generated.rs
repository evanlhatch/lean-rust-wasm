...
// spec 122ecd0+ | SchemaLang.OrderMachine (orderMachineTrans + orderMachineTableStep?_eq_step?) | 16 item(s) | content hash 8774633528911920128 | regen: just gen; drift fails CI

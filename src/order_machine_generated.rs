...
// spec 122ecd0+ | SchemaLang.OrderMachine (orderMachineTrans + orderMachineTableStep?_eq_step?) | 16 item(s) | content hash 1115646835793071670 | regen: just gen; drift fails CI

...
/// 4.33: `lean_usize_mix_hash` is gone from lean.h entirely; the 64-bit
/// definition was `lean_uint64_mix_hash` on widened args (our targets are
/// 64-bit), so port it as an inline wrapper.
#[inline(always)]
pub fn lean_usize_mix_hash(a1: usize, a2: usize) -> usize {
    super::uint64::lean_uint64_mix_hash(a1 as u64, a2 as u64) as usize
}
